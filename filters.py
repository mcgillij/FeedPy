...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEditFilter.setInputMethodHints(QtCore.Qt.ImhUrlCharactersOnly)
        ...
        self.pushButtonPlus.setInputMethodHints(QtCore.Qt.ImhNone)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_2.setText(QtGui.QApplication.translate("Dialog", "Click to remove item.", None, QtGui.QApplication.UnicodeUTF8))
